...
const ParserRules = [
    ...
    {"name": "prog", "symbols": ["prod", "ws", "prog"], "postprocess": ([a,, b]) => [a, ...b]},
    ...
    {"name": "prod", "symbols": [{"literal":"@"}, "_", "js"], "postprocess": ([,, a]) => ({body: a})},
    {"name": "prod", "symbols": [{"literal":"@"}, "word", "ws", "word"], "postprocess": d => ({config: d[1], value: d[3]})},
    {"name": "prod", "symbols": [{"literal":"@include"}, "_", "string"], "postprocess": ([,, {literal}]) => ({include: literal, builtin: false})},
    {"name": "prod", "symbols": [{"literal":"@builtin"}, "_", "string"], "postprocess": ([,, {literal}]) => ({include: literal, builtin: true })},
    ...
    {"name": "completeexpression", "symbols": ["expr", "_", "js"], "postprocess": ([a,, b]) => ({tokens: a, postprocess: b})},
    ...
    {"name": "expr_member", "symbols": [{"literal":"("}, "_", "expression+", "_", {"literal":")"}], "postprocess": ([,, a]) => ({subexpression: a})},
    {"name": "expr_member", "symbols": ["expr_member", "_", "ebnf_modifier"], "postprocess": ([a,, b]) => ({ebnf: a, modifier: b})},
    {"name": "ebnf_modifier", "symbols": [{"literal":":+"}], "postprocess": getValue},
    {"name": "ebnf_modifier", "symbols": [{"literal":":*"}], "postprocess": getValue},
    {"name": "ebnf_modifier", "symbols": [{"literal":":?"}], "postprocess": getValue},
    {"name": "expr", "symbols": ["expr_member"]},
    {"name": "expr", "symbols": ["expr", "ws", "expr_member"], "postprocess": ([a,, b]) => [...a, b]},
