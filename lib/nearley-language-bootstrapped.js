...
const ParserRules = [
    ...
    {"name": "prod", "symbols": [{"literal":"@include"}, "_", "string"], "postprocess": ([_a, _b, {literal}]) => ({include: literal, builtin: false})},
    {"name": "prod", "symbols": [{"literal":"@builtin"}, "_", "string"], "postprocess": ([_a, _b, {literal}]) => ({include: literal, builtin: true })},
