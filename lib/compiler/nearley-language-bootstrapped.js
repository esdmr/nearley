...
const ParserRules = [
	...
	new nearley.Rule("prod", ["word", new nearley.LiteralSymbol("["), "_", "wordlist", "_", new nearley.LiteralSymbol("]"), "_", new nearley.TokenSymbol("arrow"), "_", "expression+"],  d => MacroDefinition(d[0], d[3], d[9]) ),
