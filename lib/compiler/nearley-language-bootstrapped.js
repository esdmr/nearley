...
const Lexer = lexer;
const ParserRules = [
    {"name": "final", "symbols": ["_", "prog", "_", "ws$1"], "postprocess": ([, a]) => a},
    ...
    {"name": "expr_member$1", "symbols": [{"literal":"i"}], "postprocess": id},
    {"name": "expr_member$1", "symbols": [], "postprocess": (_) => null},
    {"name": "expr_member", "symbols": ["string", "expr_member$1"], "postprocess": ([a, b]) => b ? insensitive(a) : a},
    ...
    {"name": "_$1", "symbols": ["ws"], "postprocess": id},
    {"name": "_$1", "symbols": [], "postprocess": (_) => null},
    {"name": "_", "symbols": ["_$1"]},
    {"name": "ws", "symbols": [({type: "ws"})]},
    {"name": "ws$1", "symbols": [({type: "ws"})], "postprocess": id},
    {"name": "ws$1", "symbols": [], "postprocess": (_) => null},
    {"name": "ws", "symbols": ["ws$1", ({type: "comment"}), "_"]}
];
